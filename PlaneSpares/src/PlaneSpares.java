...
public PlaneSpares(String code1, String description1,
        double costPrice1, int noInStock1)
{
...
{
    String objStr = String.format("%-10s%-30s%-12.2f%-10s",code,description,costPrice,noInStock);
